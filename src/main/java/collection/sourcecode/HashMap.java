...
public class HashMap<K,V> extends AbstractMap<K,V>
                ...
                if ((e = oldTab[j]) != null) {
                    ...
                    if (e.next == null)
                        ...
                        do {
                            //下个节点
                            next = e.next;
                            //判断当前节点的hash值比hash表容量高一位的是否为1，如果是0则保持原桶
                            //如果为1到新桶
                            if ((e.hash & oldCap) == 0) {
                                if (loTail == null)
                                    loHead = e;
    ...
    /**
     * 创建EntryIterator，主要查看HashIterator的空构造方法
     */
